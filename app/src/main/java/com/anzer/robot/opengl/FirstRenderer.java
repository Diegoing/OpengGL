...
import com.anzer.robot.opengl.util.TextResourceReader;
...
/**
 * @ClassName: FirstRenderer
 * @Description: java类作用描述
 * @Author: zhouqiande
 * @Date: 2020/4/1 19:25
 */
class FirstRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        int framentShader = ShaderHelper.compileFramentShader(fragmentShaderSource);
        int vertexShader = ShaderHelper.compileVertexShader(vertexShaderSource);

        program = ShaderHelper.linkProgram(vertexShader, framentShader);
